      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
          <h1 className="text-3xl font-bold leading-10 text-white md:font-extrabold lg:text-[2.6rem] lg:leading-[3.5rem]">
            Hello, <br />
            This is {' '}
            <span className=" text-blue-500">Pritam Kasar</span>
            {` , I'm a Fresher `}
          ...
          <div className="my-12 flex items-center gap-5">
            ...
            <Link target="_blank" to={links.oldportfolio}>
              <CgWebsite
                className="transition-all text-blue-500 hover:scale-125 duration-300" size={30}
              />
            </Link>
          </div>

          <div className="flex items-center gap-3">
            <Scroll to="contact" smooth={true} className="bg-gradient-to-r to-pink-500 from-violet-600 p-[1px] rounded-full transition-all duration-300 hover:from-pink-500 hover:to-violet-600">
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div>
                ...
                <span className="text-gray-400">{`'`}</span>
                <span className="text-amber-300">Pritam Kasar</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
